...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed w-full z-50 transition-all duration-300 bg-primary-dark shadow-lg py-2`}>
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center">
          ...
          <ul className="hidden md:flex space-x-4">
            {['header', 'about', 'projects', 'experience', 'footer'].map((section) => (
              <li key={section}>
                <button
          ...
          <div className="md:hidden">
            <button
              ...
              className="text-text-light hover:text-accent-blue focus:outline-none"
