const Project = ({ project }) => {
  return (
    <div
      className="min-h-[300px] sm:min-h-[200px] bg-primary-dark border border-gray-700 rounded-2xl shadow-sm hover:shadow-lg transition-all p-6 flex flex-col justify-between"
    >
      <div>
        <h3 className="text-2xl font-semibold text-text-light mb-2">{project.title}</h3>
        <p className="text-text-gray-light text-text-gray mb-4 leading-relaxed">{project.description}</p>
